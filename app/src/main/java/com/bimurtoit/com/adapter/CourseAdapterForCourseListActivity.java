...
public class CourseAdapterForCourseListActivity extends RecyclerView.Adapter<CourseAdapterForCourseListActivity.MyViewHolder> {
    ...
    public CourseAdapterForCourseListActivity(Context context, List<Course> courses_list){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CourseAdapterForCourseListActivity.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            dialogActivity.showDialogUpdateDeleteForCourseListActivity(courseList, getAdapterPosition());
